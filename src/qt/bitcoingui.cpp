...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Pura Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pura Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Pura Core help message to get a list with possible Pura Core command-line options"));
